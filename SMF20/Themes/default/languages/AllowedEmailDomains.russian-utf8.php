...
$txt['aed_custom_error_message'] = 'Сообщение пользователю при блокировке';
$txt['aed_custom_error_message_desc'] = 'Необязательно. Этот текст отображается пользователю при попытке использовать неразрешённый почтовый домен. Если оставить поле пустым, будет использовано стандартное сообщение из языкового файла. Можно использовать подстановки: {email}, {domain}, {tld}.';
...
$txt['aed_test_user_message'] = 'Сообщение пользователю: %s';
